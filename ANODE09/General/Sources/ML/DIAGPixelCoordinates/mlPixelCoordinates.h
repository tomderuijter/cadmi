...
#ifndef __mlPixelCoordinates_H
#define __mlPixelCoordinates_H
...
//! 
class DIAGPIXELCOORDINATES_EXPORT PixelCoordinates : public Module
{
public:
...
private:
  ...
  ML_MODULE_CLASS_HEADER(PixelCoordinates)
};


ML_END_NAMESPACE

#endif // __mlPixelCoordinates_H