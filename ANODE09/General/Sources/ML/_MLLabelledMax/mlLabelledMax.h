...
#ifndef __mlLabelledMax_H
#define __mlLabelledMax_H


// Local includes
#include "_MLLabelledMaxSystem.h"
...
//! 
class _MLLABELLEDMAX_EXPORT LabelledMax : public Module
{
public:
...
private:
  ...
  ML_MODULE_CLASS_HEADER(LabelledMax)
};


ML_END_NAMESPACE

#endif // __mlLabelledMax_H