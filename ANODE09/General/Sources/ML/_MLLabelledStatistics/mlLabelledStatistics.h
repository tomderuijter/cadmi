...
#ifndef __mlLabelledStatistics_H
#define __mlLabelledStatistics_H
...
//! 
class _MLLABELLEDSTATISTICS_EXPORT LabelledStatistics : public Module
{
public:
...
private:
  ...
  ML_MODULE_CLASS_HEADER(LabelledStatistics)
};


ML_END_NAMESPACE

#endif // __mlLabelledStatistics_H
